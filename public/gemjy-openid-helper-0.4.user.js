...
// @updateURL    https://work-bad.onrender.com/gemjy-openid-helper-0.4.user.js
// @downloadURL  https://work-bad.onrender.com/gemjy-openid-helper-0.4.user.js
// @grant        GM_setValue
// @grant        GM_getValue
...
//
// 安装：Tampermonkey → 新建 → 粘本文件；或直接打开新链接
//   https://work-bad.onrender.com/gemjy-openid-helper-0.4.user.js
// （@updateURL/@downloadURL 都指向这个新链接：以后改本文件并部署，装了这一版的会自动升级；
//   别人机器上装的旧版停在旧链接，互不影响。想换版本号也不必换文件名。）
